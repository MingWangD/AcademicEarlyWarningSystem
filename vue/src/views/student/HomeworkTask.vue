<template>
  <el-card>
    <template #header>作业答题（5道选择题）</template>
...
const submit = () => request.post('/api/v1/student/homework/submit', {taskId, answers}).then(res => {ElMessage.success(`提交成功，得分 ${res.data.score}`); router.push('/portal/student/tasks')})
</script>
