...
const submit = () => request.post('/api/v1/student/exam/submit', {taskId, answers}).then(res => {
  ElMessage.success(`考试提交成功，得分 ${res.data.score}，学分 ${Number(res.data.credit || 0).toFixed(2)}，风险等级 ${res.data.riskLevel || 'LOW'}`)
