...
(6, 'stu1004',   '$2a$10$X5Q81Q7hA7vEzh6f6N0oWuQxi2P.DA7f4f8QhVfXQ4Wv0VJriM8lK', 'stu1004@school.edu',   '孙同学',     'STUDENT', 'LOW',    1, NOW()),
(7, 'stu1005',   '$2a$10$X5Q81Q7hA7vEzh6f6N0oWuQxi2P.DA7f4f8QhVfXQ4Wv0VJriM8lK', 'stu1005@school.edu',   '周同学',     'STUDENT', 'MEDIUM', 1, NOW()),
(8, 'stu1006',   '$2a$10$X5Q81Q7hA7vEzh6f6N0oWuQxi2P.DA7f4f8QhVfXQ4Wv0VJriM8lK', 'stu1006@school.edu',   '吴同学',     'STUDENT', 'LOW',    1, NOW()),
(9, 'stu1007',   '$2a$10$X5Q81Q7hA7vEzh6f6N0oWuQxi2P.DA7f4f8QhVfXQ4Wv0VJriM8lK', 'stu1007@school.edu',   '郑同学',     'STUDENT', 'HIGH',   1, NOW()),
(10, 'stu1008',  '$2a$10$X5Q81Q7hA7vEzh6f6N0oWuQxi2P.DA7f4f8QhVfXQ4Wv0VJriM8lK', 'stu1008@school.edu',   '冯同学',     'STUDENT', 'MEDIUM', 1, NOW()),
(11, 'stu1009',  '$2a$10$X5Q81Q7hA7vEzh6f6N0oWuQxi2P.DA7f4f8QhVfXQ4Wv0VJriM8lK', 'stu1009@school.edu',   '陈同学',     'STUDENT', 'LOW',    1, NOW()),
(12, 'stu1010',  '$2a$10$X5Q81Q7hA7vEzh6f6N0oWuQxi2P.DA7f4f8QhVfXQ4Wv0VJriM8lK', 'stu1010@school.edu',   '褚同学',     'STUDENT', 'HIGH',   1, NOW());
...
(1, 3,  DATE_SUB(CURDATE(), INTERVAL 2 DAY), 0.58, 'MEDIUM', '{"reason":"作业和考试中等"}'),
(2, 4,  DATE_SUB(CURDATE(), INTERVAL 2 DAY), 0.38, 'LOW',    '{"reason":"学习行为稳定"}'),
(3, 5,  DATE_SUB(CURDATE(), INTERVAL 2 DAY), 0.84, 'HIGH',   '{"reason":"作业缺交且分数偏低"}'),
(4, 6,  DATE_SUB(CURDATE(), INTERVAL 2 DAY), 0.21, 'LOW',    '{"reason":"成绩与活跃度良好"}'),
(5, 7,  DATE_SUB(CURDATE(), INTERVAL 2 DAY), 0.49, 'MEDIUM', '{"reason":"考试边缘通过"}'),
(6, 8,  DATE_SUB(CURDATE(), INTERVAL 2 DAY), 0.46, 'MEDIUM', '{"reason":"作业质量一般"}'),
(7, 9,  DATE_SUB(CURDATE(), INTERVAL 2 DAY), 0.86, 'HIGH',   '{"reason":"考试不及格"}'),
(8, 10, DATE_SUB(CURDATE(), INTERVAL 2 DAY), 0.41, 'MEDIUM', '{"reason":"仍需提升稳定性"}'),
(9, 11, DATE_SUB(CURDATE(), INTERVAL 2 DAY), 0.22, 'LOW',    '{"reason":"学习行为优秀"}'),
(10,12, DATE_SUB(CURDATE(), INTERVAL 2 DAY), 0.89, 'HIGH',   '{"reason":"长期低活跃"}'),

(11,3,   DATE_SUB(CURDATE(), INTERVAL 1 DAY), 0.55, 'MEDIUM', '{"reason":"成绩保持中等"}'),
(12,4,   DATE_SUB(CURDATE(), INTERVAL 1 DAY), 0.35, 'LOW',    '{"reason":"行为稳定"}'),
(13,5,   DATE_SUB(CURDATE(), INTERVAL 1 DAY), 0.82, 'HIGH',   '{"reason":"考试不及格"}'),
(14,6,   DATE_SUB(CURDATE(), INTERVAL 1 DAY), 0.19, 'LOW',    '{"reason":"持续良好"}'),
(15,7,   DATE_SUB(CURDATE(), INTERVAL 1 DAY), 0.47, 'MEDIUM', '{"reason":"需增加视频学习"}'),
(16,8,   DATE_SUB(CURDATE(), INTERVAL 1 DAY), 0.44, 'MEDIUM', '{"reason":"成绩波动"}'),
(17,9,   DATE_SUB(CURDATE(), INTERVAL 1 DAY), 0.83, 'HIGH',   '{"reason":"作业和考试偏弱"}'),
(18,10,  DATE_SUB(CURDATE(), INTERVAL 1 DAY), 0.39, 'LOW',    '{"reason":"状态改善"}'),
(19,11,  DATE_SUB(CURDATE(), INTERVAL 1 DAY), 0.20, 'LOW',    '{"reason":"保持优秀"}'),
(20,12,  DATE_SUB(CURDATE(), INTERVAL 1 DAY), 0.87, 'HIGH',   '{"reason":"活跃度不足"}'),

(21,3,   CURDATE(), 0.52, 'MEDIUM', '{"reason":"作业和考试中等"}'),
(22,4,   CURDATE(), 0.33, 'LOW',    '{"reason":"学习行为稳定"}'),
(23,5,   CURDATE(), 0.81, 'HIGH',   '{"reason":"作业缺交且分数偏低"}'),
(24,6,   CURDATE(), 0.18, 'LOW',    '{"reason":"成绩与活跃度突出"}'),
(25,7,   CURDATE(), 0.45, 'MEDIUM', '{"reason":"考试通过但波动较大"}'),
(26,8,   CURDATE(), 0.42, 'MEDIUM', '{"reason":"建议增加练习"}'),
(27,9,   CURDATE(), 0.80, 'HIGH',   '{"reason":"考试连续低分"}'),
(28,10,  CURDATE(), 0.37, 'LOW',    '{"reason":"近期学习改善"}'),
(29,11,  CURDATE(), 0.19, 'LOW',    '{"reason":"表现稳定"}'),
(30,12,  CURDATE(), 0.85, 'HIGH',   '{"reason":"登录和学习时长偏低"}');
